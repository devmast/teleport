...
{/*TODO: Copy this to the Cloud/Linux guide*/}
...
## Step 1/3. Upgrade the Auth Service and Proxy Service
...
{/*TODO: Configure the updater to do what?*/}
...
1. Verify updater is properly configured
   ...
   If the agent is not automatically updated, you can invoke the updater
