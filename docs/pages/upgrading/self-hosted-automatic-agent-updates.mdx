---
title: Set up Self-Hosted Automatic Agent Updates 
description: Describes how to setup automatic agent updates for self-hosted Teleport deployments.
---
...
clusters. The [Automatic Update Architecture
...
updates. If this is already done, or you are a Teleport Cloud user, you can
directly [enroll agents into automatic
updates](./enroll-agent-into-automatic-updates.mdx).
...
- Self-hosted Teleport cluster v13.0 and higher.
