---
title: Upgrading Teleport agents on Linux
description: Explains how to upgrade Teleport agents running on Linux servers.
---

This guide explains how to upgrade Teleport agents running on Linux using a
manual approach. 
...
- One or more Linux servers running a previous version of a Teleport agent.
...
{/*TODO: instructions for using systemctl or adding a new service for tar*/}
