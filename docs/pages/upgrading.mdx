...
If you run a self-hosted edition of Teleport (Enterprise and Community Edition),
you will need to upgrade the Auth Service and Proxy Service. 

After getting familiar with the Compatibility Overview, follow one of the guides
below to upgrade the Auth Service and Proxy Service, depending on the platform
in which you installed these services:
