...
func New(ctx context.Context, botConfig *BotConfig) (*EmbeddedBot, error) {
	...
	bot.clientCache = syncclient.NewCache(bot.buildClient, func() ([]byte, error) {
...
func (b *EmbeddedBot) GetSyncClient(ctx context.Context) (*syncclient.SyncClient, func(), error) {
...
func (b *EmbeddedBot) buildClient(ctx context.Context) (*syncclient.SyncClient, error) {
	...
	return syncclient.NewSyncClient(c), trace.Wrap(err)
}
